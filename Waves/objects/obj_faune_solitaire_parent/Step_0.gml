...
#region TRIGGERS
	...
	//var _predateur_presence = collision_circle(x, y, ray_flyaway, predateurs, false, true); //premier essai (good but not precise enough)
	...
	var _predateurs = collision_circle_list(x, y, ray_flyaway, predateurs, false, true, ds_list_predateurs, true);
...
//	|| ((x == xprevious) && (y == yprevious))
	...
	//FLIP
	if(move_x != 0) || (x != xprevious) { image_xscale = sign(move_x); }	
	
	if(moving == false){ sprite_index = sprite_idle; }
	if(moving == true){ sprite_index = sprite_move; }
