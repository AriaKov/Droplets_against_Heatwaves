...
if(_can_disseminate == true)
{
	...
	while (collision_circle(_x, _y, ray_coll, collisionnables, false, false) != noone)
	{
	...
	//	_seed.img_init = img_min;
		_seed.days = 0;
	
	seeds_propagated++;
	
	//Son
	//if(audio_is_playing(sound_seedling) == false){ audio_play_sound(sound_seedling, 1, false); }
}			
